...
export const API_BASE_URL = (typeof window !== 'undefined' && ((window.__ENV__ && window.__ENV__.API_BASE_URL) || window.API_BASE_URL || (window.CONFIG && window.CONFIG.API_BASE_URL))) || 'https://juice-pricing-backend.onrender.com/api';
