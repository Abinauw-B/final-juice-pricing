...
public class MarketEventService {
    ...
    public List<ProductPriceDTO> handlePurchaseEvent(PurchaseEvent event) {
        ...
        PriceHistory mainHistory = PriceHistory.builder()
                ...
                .targetSales(mainProduct.getTargetSalesPer2Minute() != null ? mainProduct.getTargetSalesPer2Minute() : 1.0)
                .demandRatio((double) qty / (mainProduct.getTargetSalesPer2Minute() != null ? mainProduct.getTargetSalesPer2Minute() : 1.0))
